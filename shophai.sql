...
values 
    ...
    ('DT331', 'SP056', 'Màn hình', '15.6"'),
    ('DT332', 'SP056', 'RAM', '8GB'),
    ('DT333', 'SP056', 'Bộ nhớ trong', '8GB'),
    ('DT334', 'SP056', 'CPU', 'Intel Celeron N4500'),
    ('DT335', 'SP056', 'Xuất xứ', 'Trung Quốc'),
    ('DT336', 'SP056', 'Thời gian ra mắt', '2021'),
    	(   'DT337','SP057',  'Màn hình', '11.6", 1366 x 768 Pixel, TN, 60 Hz, Acer ComfyView LED-backlit'   ),
(   'DT338','SP057',  'RAM',  '4 GB, DDR4, 2400 MHz'   ),
(   'DT339','SP057',  'Bộ nhớ trong',  '256 GB'   ),
(   'DT340','SP057',  'CPU',  'Intel Pentium N5030'   ),
(   'DT341','SP057',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT342','SP057',  'Thời gian ra mắt', '9/2021'   ),
(   'DT343','SP058',  'Màn hình', '15.6", 1920 x 1080 FHD, Acer ComfyView LED-backlit TFT LCD, IPS 144Hz'   ),
(   'DT344','SP058',  'RAM',  '8 GB, DDR4, 3200 MHz'   ),
(   'DT345','SP058',  'Bộ nhớ trong',  '512GB'   ),
(   'DT346','SP058',  'CPU',  'Intel Core i7-11800H'   ),
(   'DT347','SP058',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT348','SP058',  'Thời gian ra mắt', '12/2021'   ),
(   'DT349','SP059',  'Màn hình', '15.6", 1920 x 1080 Full HD, FHD'   ),
(   'DT350','SP059',  'RAM',  '4 GB, DDR4, 2400 MHz'   ),
(   'DT351','SP059',  'Bộ nhớ trong',  '256GB'   ),
(   'DT352','SP059',  'CPU',  'Intel Core i3'   ),
(   'DT353','SP059',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT354','SP059',  'Thời gian ra mắt', '3/2019'   ),
(   'DT355','SP060',  'Màn hình', '15.6", 1920 x 1080 Full HD, FHD Acer ComfyView LED LCD, 60Hz'   ),
(   'DT356','SP060',  'RAM',  'DDR4 Memory, 4 GB onboard + 4 GB khe rời cắm sẵn'   ),
(   'DT357','SP060',  'Bộ nhớ đệm',  '6 MB Intel® Smart Cache'   ),
(   'DT358','SP060',  'CPU',  'Intel® Core™ i5-1035G1'   ),
(   'DT359','SP060',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT360','SP060',  'Thời gian ra mắt', '10/2020'   ),
(   'DT361','SP061',  'Màn hình', '14.0", FHD (1920 x 1080), 60Hz IPS, LED backlight, Anti-glare'   ),
(   'DT362','SP061',  'RAM',  	'8 GB'   ),
(   'DT363','SP061',  'Bộ nhớ trong',  '512GB'   ),
(   'DT364','SP061',  'CPU',  'I5-1135G7'   ),
(   'DT365','SP061',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT366','SP061',  'Thời gian ra mắt', '3/2021'   ),
(   'DT367','SP062',  'Màn hình', '15,6", FHD (1920 x 1080) IPS, Màn hình cảm ứng, chống chói sáng, 300 nits, 45% sRGB'   ),
(   'DT368','SP062',  'RAM',  	'64GB DDR4 (3200MHz)'   ),
(   'DT369','SP062',  'Bộ nhớ trong',  '24MB'   ),
(   'DT370','SP062',  'CPU',  'Core i7-11850H vPro'   ),
(   'DT371','SP062',  'Xuất xứ',  'Việt Nam/Hàn Quốc'   ),
(   'DT372','SP062',  'Thời gian ra mắt', '6/2020'   ),
(   'DT373','SP063',  'Màn hình', '15.6",FHD (1920 x 1080), 60Hz, 250 nit, gam màu 45%'   ),
(   'DT374','SP063',  'RAM',  	'DDR4 16GB, 2933Hz'   ),
(   'DT375','SP063',  'Bộ nhớ trong',  '16GB Intel®Optane'   ),
(   'DT376','SP063',  'CPU',  ' Intel Core™ i7 thế hệ thứ 10®'),
(   'DT377','SP063',  'Xuất xứ',  'Việt Nam/Hàn Quốc'   ),
(   'DT378','SP063',  'Thời gian ra mắt', '12/2020'   ),
(   'DT379','SP064',  'Màn hình', '16.0", WQXGA 165hz'   ),
(   'DT380','SP064',  'RAM',  	'16GB'   ),
(   'DT381','SP064',  'Bộ nhớ trong',  '512GB'   ),
(   'DT382','SP064',  'CPU',  'AMD R7 5800H'   ),
(   'DT383','SP064',  'Xuất xứ',  'Việt Nam/Hàn Quốc'   ),
(   'DT384','SP064',  'Thời gian ra mắt', '10/2021'   ),
(   'DT385','SP065',  'Màn hình', '13.0", 2560 x 1600 Pixel'   ),
(   'DT386','SP065',  'RAM',  	'8 GB'   ),
(   'DT387','SP065',  'Bộ nhớ trong',  '256GB'   ),
(   'DT388','SP065',  'CPU',  'Apple M1'   ),
(   'DT389','SP065',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT390','SP065',  'Thời gian ra mắt', '6/2020'   ),
(   'DT391','SP066',  'Màn hình', '13.0", 2560 x 1600 Pixel, 	LED, IPS LCD LED Backlit, True Tone'   ),
(   'DT392','SP066',  'RAM',  	'8 GB'   ),
(   'DT393','SP066',  'Bộ nhớ trong',  '512GB'   ),
(   'DT394','SP066',  'CPU',  'Apple M1'   ),
(   'DT395','SP066',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT396','SP066',  'Thời gian ra mắt', '1/2021'   ),
(   'DT397','SP067',  'Màn hình', '13.3", 2560 x 1600 Pixel, IPS, IPS LCD LED Backlit, True Tone'   ),
(   'DT398','SP067',  'RAM',  	'8 GB, LPDDR4'   ),
(   'DT399','SP067',  'Bộ nhớ trong',  '256 GB'   ),
(   'DT400','SP067',  'CPU',  'I5-1135G7'   ),
(   'DT401','SP067',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT402','SP067',  'Thời gian ra mắt', '9/2020'   ),
(   'DT403','SP068',  'Màn hình', '15.6", 1920 x 1080 Pixel, WVA, 60 Hz, 220 nits, Wide-Viewing Angle (WVA)'   ),
(   'DT404','SP068',  'RAM',  	'16 GB, DDR4, 2933 MHz'   ),
(   'DT405','SP068',  'Bộ nhớ trong',  '512 GB'   ),
(   'DT406','SP068',  'CPU',  'AMD Ryzen 5-3450U'   ),
(   'DT407','SP068',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT408','SP068',  'Thời gian ra mắt', '11/2021'   ),
(   'DT409','SP069',  'Màn hình', '15.6", 1920 x 1080 Pixel, WVA, 120 Hz, 220 nits, WVA Anti-glare LED Backlit Narrow Border'   ),
(   'DT410','SP069',  'RAM',  	'8 GB'   ),
(   'DT411','SP069',  'Bộ nhớ trong',  '512GB'   ),
(   'DT412','SP069',  'CPU',  'Intel Core i7-10750H'   ),
(   'DT413','SP069',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT414','SP069',  'Thời gian ra mắt', '2021'   ),
(   'DT415','SP070',  'Màn hình', '15.6", 1366 x 768 Pixel, TN, 60 Hz, 220 nits, Anti-glare LED-backlit'   ),
(   'DT416','SP070',  'RAM',  	'4 GB, DDR4, 3200 MHz'   ),
(   'DT417','SP070',  'Bộ nhớ trong',  '128 GB'   ),
(   'DT418','SP070',  'CPU',  'Intel Pentium N5030'   ),
(   'DT419','SP070',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT420','SP070',  'Thời gian ra mắt', '12/2020'   ),
(   'DT421','SP071',  'Màn hình', '5.6", 1920 x 1080 Pixels, IPS, 60 Hz, 250 nits, IPS LCD'   ),
(   'DT422','SP071',  'RAM',  	'8 GB, DDR4, 2933 MHz'   ),
(   'DT423','SP071',  'Bộ nhớ trong',  '512 GB'   ),
(   'DT424','SP071',  'CPU',  'Intel Core i7-10750H'   ),
(   'DT425','SP071',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT426','SP071',  'Thời gian ra mắt', '9/2020'   ),
(   'DT427','SP072',  'Màn hình', '13.3", 1920 x 1080 Pixels, IPS, 60 Hz, 300 nits, FHD Touch'   ),
(   'DT428','SP072',  'RAM',  	'16 GB, DDR4, 2933 MHz'   ),
(   'DT429','SP072',  'Bộ nhớ trong',  '1 TB'   ),
(   'DT430','SP072',  'CPU',  'Intel Core i5-11400H'   ),
(   'DT431','SP072',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT432','SP072',  'Thời gian ra mắt', '1/2021'   ),
(   'DT433','SP073',  'Màn hình', '16.1", 1920 x 1080 Pixel, IPS, 144 Hz, 300 nits, IPS LCD'   ),
(   'DT434','SP073',  'RAM',  	'8 GB'   ),
(   'DT435','SP073',  'Bộ nhớ trong',  '512GB'   ),
(   'DT436','SP073',  'CPU',  'I5-1135G7'   ),
(   'DT437','SP073',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT438','SP073',  'Thời gian ra mắt', '3/2021'   ),
(   'DT439','SP074',  'Dung lượng', '10000 mAh'   ),
(   'DT440','SP074',  'Hiệu suất sử dụng',  'sạc đầy 1.5 lần'   ),
(   'DT441','SP074',  'Số cổng ra',  '4 cổng'   ),
(   'DT442','SP074',  'Thời gian sạc',  '90 phút đến 120 phút'   ),
(   'DT443','SP074',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT444','SP074',  'Thời gian ra mắt', '10/2021'   ),
(   'DT445','SP075',  'Dung lượng', '10000 mAh'   ),
(   'DT446','SP075',  'Hiệu suất sử dụng',  '5800 mAh (5V/2.4A)'   ),
(   'DT447','SP075',  'Số cổng ra',  '1 cổng'   ),
(   'DT448','SP075',  'Thời gian sạc',  'Khoảng 4 giờ (9V/2A hoặc 12V/1.5A)'   ),
(   'DT449','SP075',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT450','SP075',  'Thời gian ra mắt', '11/2020'   ),
(   'DT451','SP076',  'Dung lượng', '10000 mAh'   ),
(   'DT452','SP076',  'Hiệu suất sử dụng',  '70%'   ),
(   'DT453','SP076',  'Số cổng ra',  '4 cổng'   ),
(   'DT454','SP076',  'Thời gian sạc',  '6-10 giờ'   ),
(   'DT455','SP076',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT456','SP076',  'Thời gian ra mắt', '9/2021'   );
