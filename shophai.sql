...
values 
    ...
    ('DT451', 'SP040', 'Màn hình', '8.7"'),
    ('DT452', 'SP040', 'RAM', '3GB'),
    ('DT453', 'SP040', 'Bộ nhớ trong', '32GB'),
    ('DT454', 'SP040', 'CPU', 'Media Tek MT876'),
    ('DT455', 'SP040', 'Xuất xứ', 'Trung Quốc/Việt Nam'),
    ('DT456', 'SP040', 'Thời gian ra mắt', '05/2021'),
