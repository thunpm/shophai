...
values
    ...
    ('HA051', 'SP035', 'Nokia-105-DS 4G.png'),
...
values 
    ...
    ('DT229', 'SP040', 'Màn hình', '8.7"'),
    ('DT230', 'SP040', 'RAM', '3GB'),
    ('DT231', 'SP040', 'Bộ nhớ trong', '32GB'),
    ('DT232', 'SP040', 'CPU', 'Media Tek MT876'),
    ('DT233', 'SP040', 'Xuất xứ', 'Trung Quốc/Việt Nam'),
    ('DT234', 'SP040', 'Thời gian ra mắt', '05/2021'),
    ('DT235', 'SP041', 'Màn hình', '12.4"'),
    ('DT236', 'SP041', 'RAM', '4GB'),
    ('DT237', 'SP041', 'Bộ nhớ trong', '64GB'),
    ('DT238', 'SP041', 'CPU', 'Snapdragon 7500'),
    ('DT239', 'SP041', 'Xuất xứ', 'Trung Quốc/Việt Nam'),
    ('DT240', 'SP041', 'Thời gian ra mắt', '07/2021'),
    ('DT241', 'SP042', 'Màn hình', '12.4"'),
    ('DT242', 'SP042', 'RAM', '4GB'),
    ('DT243', 'SP042', 'Bộ nhớ trong', '64GB'),
    ('DT244', 'SP042', 'CPU', 'Snapdragon 7780'),
    ('DT245', 'SP042', 'Xuất xứ', 'Trung Quốc/Việt Nam'),
    ('DT246', 'SP042', 'Thời gian ra mắt', '07/2021'),
    ('DT247', 'SP043', 'Màn hình', '8.0"'),
    ('DT248', 'SP043', 'RAM', '2GB'),
    ('DT249', 'SP043', 'Bộ nhớ trong', '32GB'),
    ('DT250', 'SP043', 'CPU', 'Helio A22'),
    ('DT251', 'SP043', 'Xuất xứ', 'Trung Quốc'),
    ('DT252', 'SP043', 'Thời gian ra mắt', '10/2019'),
    ('DT253', 'SP044', 'Màn hình', '11.5"'),
    ('DT254', 'SP044', 'RAM', '4GB'),
    ('DT255', 'SP044', 'Bộ nhớ trong', '128GB'),
    ('DT256', 'SP044', 'CPU', 'Snapdragon 7300'),
    ('DT257', 'SP044', 'Xuất xứ', 'Trung Quốc'),
    ('DT258', 'SP044', 'Thời gian ra mắt', '09/2020'),
    ('DT259', 'SP045', 'Màn hình', '10.1"'),
    ('DT260', 'SP045', 'RAM', '2GB'),
    ('DT261', 'SP045', 'Bộ nhớ trong', '32GB'),
    ('DT262', 'SP045', 'CPU', 'Media Helio'),
    ('DT263', 'SP045', 'Xuất xứ', 'Trung Quốc'),
    ('DT264', 'SP045', 'Thời gian ra mắt', '07/2020'),
    ('DT265', 'SP046', 'Màn hình', '12.9"'),
    ('DT266', 'SP046', 'RAM', '8GB'),
    ('DT267', 'SP046', 'Bộ nhớ trong', '128GB'),
    ('DT268', 'SP046', 'CPU', 'Apple M1'),
    ('DT269', 'SP046', 'Xuất xứ', 'Trung Quốc'),
    ('DT270', 'SP046', 'Thời gian ra mắt', '04/2021'),
    ('DT271', 'SP047', 'Màn hình', '12.9"'),
    ('DT272', 'SP047', 'RAM', '8GB'),
    ('DT273', 'SP047', 'Bộ nhớ trong', '128GB'),
    ('DT274', 'SP047', 'CPU', 'Apple M1'),
    ('DT275', 'SP047', 'Xuất xứ', 'Trung Quốc'),
    ('DT276', 'SP047', 'Thời gian ra mắt', '04/2021'),
    ('DT277', 'SP048', 'Màn hình', '11.0"'),
    ('DT278', 'SP048', 'RAM', '16GB'),
    ('DT279', 'SP048', 'Bộ nhớ trong', '1TB'),
    ('DT280', 'SP048', 'CPU', 'Apple M1'),
    ('DT281', 'SP048', 'Xuất xứ', 'Trung Quốc'),
    ('DT282', 'SP048', 'Thời gian ra mắt', '04/2021'),
    ('DT283', 'SP049', 'Màn hình', '10.2"'),
    ('DT284', 'SP049', 'RAM', '3GB'),
    ('DT285', 'SP049', 'Bộ nhớ trong', '256GB'),
    ('DT286', 'SP049', 'CPU', 'A13 Bionic'),
    ('DT287', 'SP049', 'Xuất xứ', 'Trung Quốc'),
    ('DT288', 'SP049', 'Thời gian ra mắt', '09/2021'),
    ('DT289', 'SP050', 'Màn hình', '10.2"'),
    ('DT290', 'SP050', 'RAM', '3GB'),
    ('DT291', 'SP050', 'Bộ nhớ trong', '64GB'),
    ('DT292', 'SP050', 'CPU', 'A13 Bionic'),
    ('DT293', 'SP050', 'Xuất xứ', 'Trung Quốc'),
    ('DT294', 'SP050', 'Thời gian ra mắt', '09/2021'),
    ('DT295', 'SP051', 'Màn hình', '11.0"'),
    ('DT296', 'SP051', 'RAM', '6GB'),
    ('DT297', 'SP051', 'Bộ nhớ trong', '256GB'),
    ('DT298', 'SP051', 'CPU', 'Snapdragon 860'),
    ('DT299', 'SP051', 'Xuất xứ', 'Trung Quốc'),
    ('DT300', 'SP051', 'Thời gian ra mắt', '09/2021'),
    ('DT301', 'SP052', 'Màn hình', '15.6"'),
    ('DT302', 'SP052', 'RAM', '8GB'),
    ('DT303', 'SP052', 'Bộ nhớ trong', '8GB'),
    ('DT304', 'SP052', 'CPU', 'Intel Iris Xe Graphics'),
    ('DT305', 'SP052', 'Xuất xứ', 'Trung Quốc'),
    ('DT306', 'SP052', 'Thời gian ra mắt', '2021'),
    ('DT307', 'SP053', 'Màn hình', '15.6"'),
    ('DT308', 'SP053', 'RAM', '8GB'),
    ('DT309', 'SP053', 'Bộ nhớ trong', '8GB'),
    ('DT310', 'SP053', 'CPU', 'Intel Core i5-1135G7'),
    ('DT311', 'SP053', 'Xuất xứ', 'Trung Quốc'),
    ('DT312', 'SP053', 'Thời gian ra mắt', '2021'),
    ('DT313', 'SP054', 'Màn hình', '15.6"'),
    ('DT314', 'SP054', 'RAM', '8GB'),
    ('DT315', 'SP054', 'Bộ nhớ trong', '8GB'),
    ('DT316', 'SP054', 'CPU', 'AMD Ryzen 5-5500U'),
    ('DT317', 'SP054', 'Xuất xứ', 'Trung Quốc'),
    ('DT318', 'SP054', 'Thời gian ra mắt', '2021'),
    ('DT319', 'SP055', 'Màn hình', '15.6"'),
    ('DT320', 'SP055', 'RAM', '8GB'),
    ('DT321', 'SP055', 'Bộ nhớ trong', '8GB'),
    ('DT322', 'SP055', 'CPU', 'Intel Core i5-1135G7'),
    ('DT323', 'SP055', 'Xuất xứ', 'Trung Quốc'),
    ('DT324', 'SP055', 'Thời gian ra mắt', '2021'),
    ('DT325', 'SP056', 'Màn hình', '15.6"'),
    ('DT326', 'SP056', 'RAM', '8GB'),
    ('DT327', 'SP056', 'Bộ nhớ trong', '8GB'),
    ('DT328', 'SP056', 'CPU', 'Intel Celeron N4500'),
    ('DT329', 'SP056', 'Xuất xứ', 'Trung Quốc'),
    ('DT330', 'SP056', 'Thời gian ra mắt', '2021'),
    	(   'DT331','SP057',  'Màn hình', '11.6", 1366 x 768 Pixel, TN, 60 Hz, Acer ComfyView LED-backlit'   ),
(   'DT332','SP057',  'RAM',  '4 GB, DDR4, 2400 MHz'   ),
...
(   'DT337','SP058',  'Màn hình', '15.6", 1920 x 1080 FHD, Acer ComfyView LED-backlit TFT LCD, IPS 144Hz'   ),
(   'DT338','SP058',  'RAM',  '8 GB, DDR4, 3200 MHz'   ),
(   'DT339','SP058',  'Bộ nhớ trong',  '512GB'   ),
(   'DT340','SP058',  'CPU',  'Intel Core i7-11800H'   ),
(   'DT341','SP058',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT342','SP058',  'Thời gian ra mắt', '12/2021'   ),
(   'DT343','SP059',  'Màn hình', '15.6", 1920 x 1080 Full HD, FHD'   ),
(   'DT344','SP059',  'RAM',  '4 GB, DDR4, 2400 MHz'   ),
...
(   'DT349','SP060',  'Màn hình', '15.6", 1920 x 1080 Full HD, FHD Acer ComfyView LED LCD, 60Hz'   ),
(   'DT350','SP060',  'RAM',  'DDR4 Memory, 4 GB onboard + 4 GB khe rời cắm sẵn'   ),
(   'DT351','SP060',  'Bộ nhớ đệm',  '6 MB Intel® Smart Cache'   ),
(   'DT352','SP060',  'CPU',  'Intel® Core™ i5-1035G1'   ),
(   'DT353','SP060',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT354','SP060',  'Thời gian ra mắt', '10/2020'   ),
(   'DT355','SP061',  'Màn hình', '14.0", FHD (1920 x 1080), 60Hz IPS, LED backlight, Anti-glare'   ),
...
(   'DT361','SP062',  'Màn hình', '15,6", FHD (1920 x 1080) IPS, Màn hình cảm ứng, chống chói sáng, 300 nits, 45% sRGB'   ),
(   'DT362','SP062',  'RAM',  	'64GB DDR4 (3200MHz)'   ),
(   'DT363','SP062',  'Bộ nhớ trong',  '24MB'   ),
(   'DT364','SP062',  'CPU',  'Core i7-11850H vPro'   ),
(   'DT365','SP062',  'Xuất xứ',  'Việt Nam/Hàn Quốc'   ),
(   'DT366','SP062',  'Thời gian ra mắt', '6/2020'   ),
(   'DT367','SP063',  'Màn hình', '15.6",FHD (1920 x 1080), 60Hz, 250 nit, gam màu 45%'   ),
(   'DT368','SP063',  'RAM',  	'DDR4 16GB, 2933Hz'   ),
(   'DT369','SP063',  'Bộ nhớ trong',  '16GB Intel®Optane'   ),
(   'DT370','SP063',  'CPU',  ' Intel Core™ i7 thế hệ thứ 10®'),
(   'DT371','SP063',  'Xuất xứ',  'Việt Nam/Hàn Quốc'   ),
(   'DT372','SP063',  'Thời gian ra mắt', '12/2020'   ),
(   'DT373','SP064',  'Màn hình', '16.0", WQXGA 165hz'   ),
(   'DT374','SP064',  'RAM',  	'16GB'   ),
(   'DT375','SP064',  'Bộ nhớ trong',  '512GB'   ),
(   'DT376','SP064',  'CPU',  'AMD R7 5800H'   ),
(   'DT377','SP064',  'Xuất xứ',  'Việt Nam/Hàn Quốc'   ),
(   'DT378','SP064',  'Thời gian ra mắt', '10/2021'   ),
(   'DT379','SP065',  'Màn hình', '13.0", 2560 x 1600 Pixel'   ),
...
(   'DT385','SP066',  'Màn hình', '13.0", 2560 x 1600 Pixel, 	LED, IPS LCD LED Backlit, True Tone'   ),
...
(   'DT391','SP067',  'Màn hình', '13.3", 2560 x 1600 Pixel, IPS, IPS LCD LED Backlit, True Tone'   ),
(   'DT392','SP067',  'RAM',  	'8 GB, LPDDR4'   ),
...
(   'DT397','SP068',  'Màn hình', '15.6", 1920 x 1080 Pixel, WVA, 60 Hz, 220 nits, Wide-Viewing Angle (WVA)'   ),
(   'DT398','SP068',  'RAM',  	'16 GB, DDR4, 2933 MHz'   ),
...
(   'DT403','SP069',  'Màn hình', '15.6", 1920 x 1080 Pixel, WVA, 120 Hz, 220 nits, WVA Anti-glare LED Backlit Narrow Border'   ),
(   'DT404','SP069',  'RAM',  	'8 GB'   ),
(   'DT405','SP069',  'Bộ nhớ trong',  '512GB'   ),
(   'DT406','SP069',  'CPU',  'Intel Core i7-10750H'   ),
(   'DT407','SP069',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT408','SP069',  'Thời gian ra mắt', '2021'   ),
(   'DT409','SP070',  'Màn hình', '15.6", 1366 x 768 Pixel, TN, 60 Hz, 220 nits, Anti-glare LED-backlit'   ),
(   'DT410','SP070',  'RAM',  	'4 GB, DDR4, 3200 MHz'   ),
...
(   'DT415','SP071',  'Màn hình', '5.6", 1920 x 1080 Pixels, IPS, 60 Hz, 250 nits, IPS LCD'   ),
(   'DT416','SP071',  'RAM',  	'8 GB, DDR4, 2933 MHz'   ),
(   'DT417','SP071',  'Bộ nhớ trong',  '512 GB'   ),
(   'DT418','SP071',  'CPU',  'Intel Core i7-10750H'   ),
(   'DT419','SP071',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT420','SP071',  'Thời gian ra mắt', '9/2020'   ),
(   'DT421','SP072',  'Màn hình', '13.3", 1920 x 1080 Pixels, IPS, 60 Hz, 300 nits, FHD Touch'   ),
(   'DT422','SP072',  'RAM',  	'16 GB, DDR4, 2933 MHz'   ),
(   'DT423','SP072',  'Bộ nhớ trong',  '1 TB'   ),
(   'DT424','SP072',  'CPU',  'Intel Core i5-11400H'   ),
(   'DT425','SP072',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT426','SP072',  'Thời gian ra mắt', '1/2021'   ),
(   'DT427','SP073',  'Màn hình', '16.1", 1920 x 1080 Pixel, IPS, 144 Hz, 300 nits, IPS LCD'   ),
...
(   'DT434','SP074',  'Hiệu suất sử dụng',  'sạc đầy 1.5 lần'   ),
(   'DT435','SP074',  'Số cổng ra',  '4 cổng'   ),
(   'DT436','SP074',  'Thời gian sạc',  '90 phút đến 120 phút'   ),
(   'DT437','SP074',  'Xuất xứ',  'Trung Quốc'   ),
(   'DT438','SP074',  'Thời gian ra mắt', '10/2021'   ),
(   'DT439','SP075',  'Dung lượng', '10000 mAh'   ),
(   'DT440','SP075',  'Hiệu suất sử dụng',  '5800 mAh (5V/2.4A)'   ),
(   'DT441','SP075',  'Số cổng ra',  '1 cổng'   ),
(   'DT442','SP075',  'Thời gian sạc',  'Khoảng 4 giờ (9V/2A hoặc 12V/1.5A)'   ),
