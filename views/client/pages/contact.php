...
<div class="contact__title">
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d12896.241647124238!2d108.15222325714015!3d16.06156725364652!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1svi!2s!4v1638749790256!5m2!1svi!2s" width="1060" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    </div>
    ...
    <div class="contact-content">
        ...
        <span>
            <p class="contact-infor__right-title" > HAI SHOP chào đón đối tác ngỏ ý liên hệ với HAI SHOP. Vui lòng liên hệ theo biểu mẫu dưới. HAI SHOP sẽ hồi âm trong thời gian nhanh nhất.</p>
        </span>
        <div class="contact-infor__right-from">
                ...
                <tbody>
                    <tr >
                        ...
                        <td class="contact-infor__right-from-td">
                            <input class="form-control" placeholder="Nhập họ và tên" id="name" name="name" type="text" value="">
                        </td>
                    </tr>
                    <tr >
                        <td class="contact-infor__right-from-td" style="width:150px;">
                            <span class="contact-infor__right-from-red">(*)</span>
                                Email: </td>
                        <td class="contact-infor__right-from-td">
                            <input class="form-control" placeholder="Nhập Email" id="email" name="email" type="email" value="">
                        </td>
                    </tr>
                    ...
                    <tr >
                        <td class="contact-infor__right-from-td" style="width:150px;">
                            <span class="contact-infor__right-from-red">(*)</span>
                                Điện thoại:</td>
                        <td class="contact-infor__right-from-td">
                            <input class="form-control" placeholder="Nhập số điện thoại" id="number" name="phone_number" type="text" value="">
                        </td>
                    </tr>
                    <tr >
                        <td class="contact-infor__right-from-td" style="width:150px;">
                        &nbsp &nbsp &nbsp
                            Địa chỉ:</td>
                        <td class="contact-infor__right-from-td">
                            <textarea class="required form-control" placeholder="Nhập địa chỉ" id="address" name="address" rows="2"></textarea>
                        </td>
                    </tr>
                    <tr >
                        <td class="contact-infor__right-from-td" style="width:150px;">
                            ...
                            Tiêu đề:</td>
                        <td class="contact-infor__right-from-td">
                            <input class="form-control" placeholder="Nhập tiêu đề" id="title" name="title" type="text" value="">
                        </td>
                    </tr>
                    <tr >
                        <td class="contact-infor__right-from-td" style="width:150px;">
                            ...
                            <textarea class="required form-control" placeholder="Nhập nội dung" id="Description" name="Description" rows="2"></textarea>
                        </td>
                    </tr>
                    ...
                    <tr >
                        ...
                        <td class="contact__right-from-btn">
                            <a href="" >
                                <input class="btn btn-bb" type="submit" value="GỬI">
                            </a>
                        </td>
                    </tr>
