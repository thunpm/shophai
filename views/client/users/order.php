...
<div class="main-block">
    <div class="content">
        ...
        <div class="alert alert-success d-none alert-rating-success">
            Thành công! Cảm ơn đã gửi đánh giá sản phẩm cho chúng tôi.
        </div>
        <div class="alert alert-danger d-none alert-rating-fail">
                                                ...
                                                <div class="modal-body"> 
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button
                                                                    class="btn btn-rating-product" 
                                                                    type="button" 
                                                                    data-masp="<?= $item->sanPham->maSP ?>" 
                                                                    data-makh="<?= $order->maKH ?>" 
                                                                    data-dismiss="modal" 
                                                                    data-toggle="modal" 
                                                                    data-target="#modal-rating"
                                                                >Viết</button>
                                                            </td>
                                                        </tr>
                                                        <?php
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 d-flex justify-content-center">
                        <button 
                            class="btn btn-primary btn-submit-rating mt-2" 
                            type="button" 
                            data-url="index.php?controller=product&action=rating2"
                        >
                    ...
                    <p class="text-error error d-none" style="padding-left: 15px; margin-top: 10px"></p>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
	$(document).ready(function() {
        ...
        $('.btn-rating-product').on('click', function () {
            maSP = $(this).data('masp');
            maKH = $(this).data('makh');
        })
        ...
        function submitRating(url) {
            ...
            let rating = 0;
            $('.feedback .rating').find('input').each(function (index, item) {
                if ($(item).is(':checked')) {
                    rating = $(item).val();
                }
            });
            ...
            if (rating === 0) {
                messageError = 'Bạn chưa chọn số sao để đánh giá';
            }
            if (rating && !content) {
                messageError = 'Bạn chưa nhập nội dung đánh giá';
            }
            if (messageError) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response == 400) {
                        ...
                        $('.alert-rating-success').removeClass('d-none');
                        setTimeout(() => {
